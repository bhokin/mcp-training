...
Mount multiple FastMCP servers under distinct prefixes (e.g. /hr/mcp, /utility/mcp)
and combine their lifespans into FastAPI.

TO ADD A NEW MCP SERVER:
    Step 1: Create mcp_servers/your_server.py with a FastMCP instance
    Step 2: Import it here and call http_app(stateless_http=True)
